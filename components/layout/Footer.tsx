  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-screen-2xl flex-col items-center gap-6 border-t border-outline-variant pt-8 text-center md:flex-row md:justify-between">
        ...
        <div className="inline-flex items-center gap-2 rounded-md bg-[#081619] px-3 py-1.5 transition-transform duration-300 ease-out hover:scale-105">
          <a
            href="https://transitioneg.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="font-body-md text-xs font-bold tracking-wide text-white hover:underline"
          >
            Transition
          </a>
          <Image
